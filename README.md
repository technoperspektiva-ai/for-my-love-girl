...
## v193 Remove dead overlay block

- Прибрано/заховано старий неактивний overlay-блок із тестовим `web-page.blogspot.com`.
- Це не функціональний блок, тому він більше не має висіти поверх dashboard.
- База: user-provided v191 clean base.
